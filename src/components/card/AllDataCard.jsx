    ...
    <View style={styles.containerInitial}>
      ...
      >
        ...
        <View>
          ...
          <View style={handlerTheme}>
            <Text style={handlerSubtTextChild}>
              {handlerLanguage("minimal")}
            </Text>
            <Text style={handlerSubtTextChild}>
              {handlerLanguage("current")}
            </Text>
            <Text style={handlerSubtTextChild}>
              {handlerLanguage("maximum")}
            </Text>
          </View>
          <View style={handlerTheme}>
        ...
        <View>
          <View style={handlerTheme}>
            <Text style={handlerSubtTextChild}>
              {handlerLanguage("sunrise")}
            </Text>
            <Text style={handlerSubtTextChild}>
              {handlerLanguage("sunset")}
            </Text>
          </View>
          <View style={handlerTheme}>
            <Text style={handlerSubtTextChild}>
